...
$nav_items = [
    ...
    ['key' => 'reports',      'href' => 'reports.php',     'label' => 'Reports & Analytics','soon' => null, 'icon' => '<path d="M4 13h8"/><path d="M5.4 7.4h1.6v5.6H5.4z"/><path d="M8.3 4.6h1.6v8.4H8.3z"/>'],
    ['key' => 'logs',         'href' => 'logs.php',        'label' => 'System Logs',        'soon' => null, 'icon' => '<circle cx="8" cy="8" r="5.6"/><path d="M8 5.2V8l2 1.6"/>'],
    ['key' => 'maintenance',  'href' => 'maintenance.php','label' => 'Maintenance',        'soon' => null, 'icon' => '<path d="M2.6 4.4h5.6"/><path d="M11.6 4.4h1.8"/><circle cx="9.8" cy="4.4" r="1.6"/><path d="M2.6 9.6h1.8"/><path d="M7.8 9.6h5.6"/><circle cx="6" cy="9.6" r="1.6"/><path d="M2.6 14.8h5.6"/><path d="M11.6 14.8h1.8"/><circle cx="9.8" cy="14.8" r="1.6"/>'],
];
